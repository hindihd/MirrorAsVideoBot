...
if __name__ == "__main__" :
    ...
    upload_as_doc_handler = MessageHandler(
        upload_as_doc,
        filters=Filters.command("uploadasdoc@YoutubeZoneBot") & Filters.chat(chats=AUTH_CHANNEL)
    )
    app.add_handler(upload_as_doc_handler)
    #
    upload_as_video_handler = MessageHandler(
        upload_as_video,
        filters=Filters.command("uploadasvideo@YoutubeZoneBot") & Filters.chat(chats=AUTH_CHANNEL)
    )
